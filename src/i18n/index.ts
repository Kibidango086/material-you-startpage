...
const dict: Dict = {
  ...
  'saysTab.aiHint': {
    'zh-CN': 'Key 仅保存在本机 localStorage，纯前端调用。未填写 Key 时点击刷新会显示引导提示而非报错。',
    'zh-TW': 'Key 僅保存在本機 localStorage，純前端呼叫。未填寫 Key 時點擊重新整理會顯示引導提示而非報錯。',
    en: 'Key stays in localStorage, pure front-end. Empty key shows a hint, not an error.',
    ja: 'Key は localStorage のみに保存。未入力時はエラーでなく案内を表示。',
  },
  'saysTab.refreshNow': {
    'zh-CN': '立即刷新',
    'zh-TW': '立即重新整理',
  ...
  'saysTab.customContent': {
    'zh-CN': '自定义一言内容',
    'zh-TW': '自訂一言內容',
    en: 'Custom quote content',
    ja: '一言の内容をカスタム',
  },
  'saysTab.customContentPlaceholder': {
    'zh-CN': '输入你想显示的文字',
    'zh-TW': '輸入你想顯示的文字',
    en: 'Enter the text to show',
    ja: '表示するテキストを入力',
  },
  'saysTab.customAuthor': {
    'zh-CN': '署名（出处）',
    'zh-TW': '署名（出處）',
    en: 'Attribution',
    ja: '署名（出典）',
  },
  'saysTab.customAuthorPlaceholder': {
    'zh-CN': '如：佚名',
    'zh-TW': '如：佚名',
    en: 'e.g. Anonymous',
    ja: '例：匿名',
  },
  'saysTab.aiEndpointLabel': {
    'zh-CN': 'OpenAI 兼容接口（endpoint）',
    'zh-TW': 'OpenAI 相容介面（endpoint）',
    en: 'OpenAI-compatible endpoint',
    ja: 'OpenAI 互換エンドポイント',
  },
  'saysTab.aiModelLabel': {
    'zh-CN': '模型',
    'zh-TW': '模型',
    en: 'Model',
    ja: 'モデル',
  },
  'saysTab.aiPromptLabel': {
    'zh-CN': 'Prompt（生成每日一句的提示词）',
    'zh-TW': 'Prompt（生成每日一句的提示詞）',
    en: 'Prompt (for generating the quote)',
    ja: 'プロンプト（一言生成用）',
  },
  'saysTab.aiHint2': {
    'zh-CN': 'Key 仅保存在本机 localStorage，纯前端调用。未填写 Key 时点击刷新会显示引导提示而非报错。',
  ...
  'ai.notConfigured': {
    'zh-CN': 'AI 一言尚未配置 — 请在「设置 → 一言」中填写 API Key 与接口地址后点击刷新',
    'zh-TW': 'AI 一言尚未設定 — 請在「設定 → 一言」中填寫 API Key 與介面位址後點擊重新整理',
    en: 'AI quote not configured — fill in API Key & endpoint in Settings → Quote, then refresh',
    ja: 'AI 一言が未設定です — 設定 → 一言 で API Key とエンドポイントを入力し、更新してください',
  },
  'ai.notConfiguredEndpoint': {
    'zh-CN': 'AI 一言尚未配置 — 请在「设置 → 一言」中填写 OpenAI 兼容接口地址（endpoint）',
    'zh-TW': 'AI 一言尚未設定 — 請在「設定 → 一言」中填寫 OpenAI 相容介面位址（endpoint）',
    en: 'AI quote not configured — fill in the OpenAI-compatible endpoint in Settings → Quote',
    ja: 'AI 一言が未設定です — 設定 → 一言 で OpenAI 互換エンドポイントを入力してください',
  },
  'saysTab.refreshHint': {
    'zh-CN': '页面底部一言点击亦可刷新',
